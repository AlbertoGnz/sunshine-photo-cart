...
add_action( 'plugins_loaded', 'sunshine_load_textdomain' );
function sunshine_load_textdomain() {
	load_plugin_textdomain( 'sunshine', false, plugin_basename( dirname( __FILE__ ) ) . '/languages' );
}
