...
$options[] = array(
	'name' => __( 'Price with tax suffix', 'sunshine' ),
...
$options[] = array(
	'name' => __( 'Use Shortcode', 'sunshine' ),
	'id'   => 'use_shortcode',
	'type' => 'checkbox',
	'desc' => __( 'By default Sunshine is automatically shown on the above page. However, if you are using a Page Builder you may want to be more specific about where Sunshine appears by using the shortcode [sunshine]. Check this option AND use the shortcode in your Page Builder.','sunshine' ),
	'options' => array( 1 )
);
$options[] = array(
