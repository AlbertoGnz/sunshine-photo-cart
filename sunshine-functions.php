...
function sunshine_checkout_update_totals() {
	...
	if ( isset( $_POST['shipping_method'] ) ) {
		...
		$return['shipping'] = sunshine_money_format( $return['shipping'], false, !$sunshine->shipping->is_taxable( $_POST['shipping_method'] ) );
	}
	$return['credits'] = '-'.sunshine_money_format( $sunshine->cart->useable_credits, false, true );
...
?>
	<li id="sunshine-checkout-step-notes">
		<fieldset id="sunshine-notes">
			...
			<b>Indicándonos</b> si es un álbum (analógico o digital), si es un pack de fotos sueltas…<br>
			<b>Pedidos con recordatorios:</b> Indicanos si llevan nombre, nombre y fecha, o nada.<br>
