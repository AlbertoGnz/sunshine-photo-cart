	...
	if ( !$sunshine->is_pro() && ( ( current_time('timestamp') - $install_time ) >= DAY_IN_SECONDS * 30 ) ) {
		...
		*/
		...
		$discount_text = '<p>You having been using Sunshine Photo Cart for quite a while and that\'s great! However, it appears you are not enjoying the awesome features of having a Sunshine Pro bundle license (all the add-ons and 1-on-1 priority support).</p><p><strong>I am doing a limited-time offer of $' . $discount_percent . ' off a Sunshine Pro license!</strong> Sunshine <em>rarely</em> does any kind of discounts.</p>
						...
						<a href="https://www.sunshinephotocart.com/pro/?promo=1&discount=' . $discount_code . '&utm_source=plugin&utm_medium=notice&utm_content=' . $discount_percent . 'dollars&utm_campaign=PluginProUpgrade" class="button" target="_blank">Learn more about Pro</a>
